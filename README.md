...
Memory for the most recent allocation *can* be reclaimed. You can also use [scopes, checkpoints](#scopes-and-checkpoints) and [`reset`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.reset) to reclaim memory.
...
```
The fact that the bump allocator allocates ever larger chunks and [`reset`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.reset) only keeps around the largest one means that after a few iterations, every bump allocation
...
- Drop is always called for allocated values unless explicitly [leaked](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpBox.html#method.leak) or [forgotten](https://doc.rust-lang.org/core/mem/fn.forget.html).
  - `alloc*` methods return a [`BumpBox<T>`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpBox.html) which owns and drops `T`. Types that don't need dropping can be turned into references with [`into_ref`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpBox.html#method.into_ref) and [`into_mut`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpBox.html#method.into_mut).
- You can allocate a slice from any `Iterator` with [`alloc_iter`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.alloc_iter).
...
You can create a new scope either with a [`scoped`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.scoped) closure or with a [`scope_guard`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.scope_guard):
```rust
use bump_scope::Bump;
...
assert_eq!(bump.stats().allocated(), 0);
```
You can also use the unsafe [`checkpoint`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.checkpoint) api
...
- [`Fixed*`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.FixedBumpVec.html) for fixed capacity collections
- [`Mut*`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.MutBumpVec.html) for collections optimized for a mutable bump allocator

##### API changes
The collections are designed to have the same api as their std counterparts with these exceptions:
- [`split_off`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpVec.html#method.split_off) —  splits the collection in place without allocation; the parameter is a range instead of a single index
- [`retain`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpVec.html#method.retain) —  takes a closure with a `&mut T` parameter like `Vec::retain_mut`

##### New features
- [`append`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpVec.html#method.append) —  allows appending all kinds of owned slice types like `[T; N]`, `Box<[T]>`, `Vec<T>`, `vec::Drain<T>` etc.
- [`map`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpVec.html#method.map) —  maps the elements, potentially reusing the existing allocation
- [`map_in_place`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpVec.html#method.map_in_place) —  maps the elements without allocation, failing to compile if not possible
...
This allows you to [bump allocate collections](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#collections).
...
- **`bytemuck`** — Adds `bytemuck::*` extension traits for
  <code>[alloc_zeroed](https://docs.rs/bump-scope/1.5.0/bump_scope/bytemuck/trait.BumpExt.html#tymethod.alloc_zeroed)([_slice](https://docs.rs/bump-scope/1.5.0/bump_scope/bytemuck/trait.BumpExt.html#tymethod.alloc_zeroed_slice))</code>,
  [`init_zeroed`](https://docs.rs/bump-scope/1.5.0/bump_scope/bytemuck/trait.InitZeroed.html#tymethod.init_zeroed),
  [`extend_zeroed`](https://docs.rs/bump-scope/1.5.0/bump_scope/bytemuck/trait.VecExt.html#tymethod.extend_zeroed) and
  [`resize_zeroed`](https://docs.rs/bump-scope/1.5.0/bump_scope/bytemuck/trait.VecExt.html#tymethod.resize_zeroed).
- **`zerocopy-08`** — Adds `zerocopy_08::*` extension traits for
  <code>[alloc_zeroed](https://docs.rs/bump-scope/1.5.0/bump_scope/zerocopy_08/trait.BumpExt.html#tymethod.alloc_zeroed)([_slice](https://docs.rs/bump-scope/1.5.0/bump_scope/zerocopy_08/trait.BumpExt.html#tymethod.alloc_zeroed_slice))</code>,
  [`init_zeroed`](https://docs.rs/bump-scope/1.5.0/bump_scope/zerocopy_08/trait.InitZeroed.html#tymethod.init_zeroed),
  [`extend_zeroed`](https://docs.rs/bump-scope/1.5.0/bump_scope/zerocopy_08/trait.VecExt.html#tymethod.extend_zeroed) and
  [`resize_zeroed`](https://docs.rs/bump-scope/1.5.0/bump_scope/zerocopy_08/trait.VecExt.html#tymethod.resize_zeroed).
- **`allocator-api2-02`** — Makes `Bump(Scope)` implement `allocator_api2` version `0.2`'s `Allocator` and
  ...
  [`AllocatorApi2V02Compat`](https://docs.rs/bump-scope/1.5.0/bump_scope/alloc/compat/struct.AllocatorApi2V02Compat.html).
- **`allocator-api2-03`** — Makes `Bump(Scope)` implement `allocator_api2` version `0.3`'s `Allocator` and
  makes it possible to use an `allocator_api2::alloc::Allocator` as a base allocator via
  [`AllocatorApi2V03Compat`](https://docs.rs/bump-scope/1.5.0/bump_scope/alloc/compat/struct.AllocatorApi2V03Compat.html).
- **`allocator-api2-04`** — Makes `Bump(Scope)` implement `allocator_api2` version `0.4`'s `Allocator` and
  makes it possible to use an `allocator_api2::alloc::Allocator` as a base allocator via
  [`AllocatorApi2V04Compat`](https://docs.rs/bump-scope/1.5.0/bump_scope/alloc/compat/struct.AllocatorApi2V04Compat.html).
...
- **`nightly-allocator-api`** — Makes `Bump(Scope)` implement `alloc`'s `Allocator` and
  ...
  [`AllocatorNightlyCompat`](https://docs.rs/bump-scope/1.5.0/bump_scope/alloc/compat/struct.AllocatorNightlyCompat.html).
...
- **`nightly-clone-to-uninit`** — Adds [`alloc_clone`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.alloc_clone) method to `Bump(Scope)`.
...
This benefits collections as well as <code>[alloc_iter](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.alloc_iter)([_mut](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.alloc_iter_mut))</code> and <code>[alloc_fmt](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.alloc_fmt)([_mut](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.alloc_fmt_mut))</code>
with the exception of [`MutBumpVecRev`] and [`alloc_iter_mut_rev`](https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.alloc_iter_mut_rev) which
...
[`unsize_bump_box`]: https://docs.rs/bump-scope/1.5.0/bump_scope/macro.unsize_bump_box.html
[`WithoutShrink`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.WithoutShrink.html
[`WithoutDealloc`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.WithoutDealloc.html
[`MutBumpVecRev`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.MutBumpVecRev.html
[`Bump`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html
[`BumpVec`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpVec.html
[`BumpString`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpString.html
[`BumpPool`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.BumpPool.html
[`Allocator`]: https://docs.rs/bump-scope/1.5.0/bump_scope/alloc/trait.Allocator.html
[CHANGELOG]: https://docs.rs/bump-scope/1.5.0/bump_scope/CHANGELOG/index.html
[`into_guaranteed_allocated`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.into_guaranteed_allocated
[`as_mut_guaranteed_allocated`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.as_mut_guaranteed_allocated
[`as_guaranteed_allocated`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.as_guaranteed_allocated
[`scope_guard`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.scope_guard
[`aligned`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.aligned
[`scoped_aligned`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.scoped_aligned
[`scoped`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.scoped
[`unallocated`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.unallocated
[`with_capacity`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.with_capacity
[`with_size`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.with_size
[`new`]: https://docs.rs/bump-scope/1.5.0/bump_scope/struct.Bump.html#method.new
