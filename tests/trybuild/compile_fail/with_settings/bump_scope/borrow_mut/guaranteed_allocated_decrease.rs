...
type In = <BumpSettings as BumpAllocatorSettings>::WithGuaranteedAllocated<true>;
type Out = <BumpSettings as BumpAllocatorSettings>::WithGuaranteedAllocated<false>;
