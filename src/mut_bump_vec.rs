...
use crate::{
    ...
    BumpBox, BumpScope, Drain, ErrorBehavior, ExtractIf, FixedBumpVec, GuaranteedAllocatedStats, IntoIter,
    MaybeUnallocatedStats, MinimumAlignment, NoDrop, SetLenOnDropByPtr, SizedTypeProperties, SupportedMinimumAlignment,
};
...
impl<'b, 'a: 'b, T, const MIN_ALIGN: usize, const UP: bool, A> MutBumpVec<'b, 'a, T, A, MIN_ALIGN, UP>
where
    MinimumAlignment<MIN_ALIGN>: SupportedMinimumAlignment,
    A: Allocator + Clone,
{
...
impl<'b, 'a: 'b, T, const MIN_ALIGN: usize, const UP: bool, A> MutBumpVec<'b, 'a, T, A, MIN_ALIGN, UP, false>
where
    MinimumAlignment<MIN_ALIGN>: SupportedMinimumAlignment,
    A: Allocator + Clone,
{
