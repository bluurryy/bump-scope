...
use crate::{
    ...
    polyfill::pointer, BumpScope, Checkpoint, ErrorBehavior, GuaranteedAllocatedStats, MinimumAlignment, RawChunk,
    ScopeGuardRoot, Stats, SupportedMinimumAlignment, WithoutDealloc, WithoutShrink, DEFAULT_START_CHUNK_SIZE,
};
...
where
    ...
    A: Allocator + Clone,
{
    bump_scope_methods!(ScopeGuardRoot, false);
}
