use core::{ffi::CStr, fmt, mem::MaybeUninit, ptr, slice};

use crate::{
    panic_on_error, polyfill::nonnull, BaseAllocator, Bump, BumpAllocator, BumpBox, BumpScope, BumpString, BumpVec,
    FixedBumpString, FixedBumpVec, MinimumAlignment, SizedTypeProperties, SupportedMinimumAlignment, WithoutDealloc,
    WithoutShrink,
};
...
unsafe impl<'a, A: BumpAllocatorScope<'a>> BumpAllocatorScope<'a> for &mut A {}
