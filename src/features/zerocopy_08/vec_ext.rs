...
impl<T: FromZeros, A: BumpAllocatorTyped> PrivateVecExt for BumpVec<T, A> {
    #[inline]
    fn generic_extend_zeroed<E: ErrorBehavior>(&mut self, additional: usize) -> Result<(), E> {
        self.generic_reserve(additional)?;
...
impl<T: FromZeros, A: MutBumpAllocatorTyped> PrivateVecExt for MutBumpVec<T, A> {
    #[inline]
    fn generic_extend_zeroed<E: ErrorBehavior>(&mut self, additional: usize) -> Result<(), E>
    where
        T: FromZeros,
...
impl<T: FromZeros, A: MutBumpAllocatorTyped> PrivateVecExt for MutBumpVecRev<T, A> {
    #[inline]
    fn generic_extend_zeroed<E: ErrorBehavior>(&mut self, additional: usize) -> Result<(), E> {
        self.generic_reserve(additional)?;
