...
///
/// This type is the error type for the [`String::from_utf8`](crate::String::from_utf8), [`MutString::from_utf8`](crate::MutString::from_utf8) and [`Box<[u8]>::into_boxed_str`](crate::Box::into_boxed_str). It
